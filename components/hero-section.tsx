...
export const HeroSection: FC<HeroSectionProps> = ({ onGetStarted }) => {
  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-b from-white via-blue-50/30 to-purple-50/20 dark:from-gray-900 dark:via-blue-950/30 dark:to-purple-950/20 pt-20 transition-colors duration-500">
          ...
          <div className="text-center lg:text-left space-y-8 animate-fade-in">
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-black leading-[1.1] tracking-tight min-h-[280px] md:min-h-[320px]">
              <span 
                ...
                className="block text-gray-900 dark:text-gray-100 mb-2 animate-title-fade-in"
              >
                {rotatingTitles[currentTitleIndex].line1}
              </span>
              <span 
                key={`highlight-${currentTitleIndex}`}
                className="block bg-gradient-to-r from-red-600 via-orange-600 to-red-600 dark:from-orange-400 dark:via-red-400 dark:to-orange-400 bg-clip-text text-transparent animate-gradient-x bg-[length:200%_auto] animate-title-fade-in"
              ...
              <span 
                ...
                className="block text-gray-900 dark:text-gray-100 mt-2 animate-title-fade-in"

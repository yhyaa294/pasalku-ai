    ...
    <section id="features" className={`py-20 md:py-32 px-4 bg-gradient-to-b from-white via-blue-50/20 to-white relative overflow-hidden ${className}`}>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="mt-16 text-center">
          <a href="/features" className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-full font-semibold shadow-lg hover:shadow-xl hover:scale-105 transition-all">

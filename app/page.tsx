...
export default function PasalkuLandingPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      {/* FAQ Section */}
      <section id="faq" className="py-16 md:py-32 px-4 scroll-animate">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 md:mb-20">
            <h2 className="text-4xl md:text-6xl font-black mb-6 md:mb-8 animate-text-shimmer">
            ...
            <p className="text-lg md:text-2xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
              Jawaban untuk pertanyaan yang sering diajukan tentang platform AI legal terdepan ini
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 md:gap-8">
            {[
              {
                question: "Apakah hasil analisis AI dapat diandalkan untuk kasus hukum?",
                answer:
                  "Ya, platform kami menggunakan teknologi AI terdepan dengan tingkat akurasi 99.9% yang telah divalidasi oleh tim ahli hukum berpengalaman. Database kami mencakup ribuan dokumen hukum Indonesia yang selalu diperbarui.",
              },
              {
                question: "Bagaimana keamanan data pribadi saya dijamin?",
                answer:
                  "Kami menggunakan enkripsi 256-bit tingkat militer dan mematuhi standar keamanan internasional. Data Anda tidak akan pernah dibagikan kepada pihak ketiga dan disimpan dengan protokol keamanan tertinggi.",
              },
              {
                question: "Apakah bisa digunakan untuk semua jenis kasus hukum?",
                answer:
                  "Platform kami mendukung berbagai bidang hukum termasuk hukum perdata, pidana, bisnis, keluarga, dan hukum adat. Database kami mencakup peraturan dari tingkat daerah hingga nasional.",
              },
              {
                question: "Berapa lama waktu yang dibutuhkan untuk mendapat hasil analisis?",
                answer:
                  "Analisis AI kami memberikan hasil dalam hitungan detik. Untuk analisis yang lebih kompleks, maksimal 2-3 menit Anda sudah mendapatkan hasil yang komprehensif dan detail.",
              },
              {
                question: "Apakah ada garansi uang kembali jika tidak puas?",
                answer:
                  "Ya, kami memberikan garansi 30 hari uang kembali tanpa pertanyaan. Jika Anda tidak puas dengan layanan kami, dana akan dikembalikan 100%.",
              },
              {
                question: "Bisakah diintegrasikan dengan sistem yang sudah ada?",
                answer:
                  "Tentu saja! Kami menyediakan API yang mudah diintegrasikan dengan sistem existing Anda. Tim teknis kami siap membantu proses integrasi.",
              },
            ].map((faq, index) => (
              <div
                key={index}
                ...
                style={{ animationDelay: `${index * 0.1}s` }}
              >
                <h3 className="text-lg md:text-xl font-bold mb-3 md:mb-4 text-primary animate-text-shimmer">
                  {faq.question}
                </h3>
      ...
      <section id="supported-areas" className="py-16 md:py-32 px-4 bg-muted/20 scroll-animate">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 md:mb-20">
            ...
            <p className="text-lg md:text-2xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
              Platform AI kami mendukung berbagai bidang hukum dengan database terlengkap di Indonesia
            </p>
          </div>

          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
            {[
              { icon: Gavel, name: "Hukum Pidana", desc: "Kasus pidana & pelanggaran" },
              { icon: Building, name: "Hukum Perdata", desc: "Kontrak & sengketa perdata" },
              { icon: Shield, name: "Hukum Bisnis", desc: "Korporasi & perdagangan" },
              { icon: Scale, name: "Hukum Keluarga", desc: "Pernikahan & warisan" },
              { icon: FileText, name: "Hukum Tanah", desc: "Properti & pertanahan" },
              { icon: Globe, name: "Hukum Internasional", desc: "Perdagangan internasional" },
              { icon: Lock, name: "Hukum Cyber", desc: "Teknologi & data" },
              { icon: Award, name: "Hukum Adat", desc: "Tradisional & lokal" },
            ].map((area, index) => (
              <div
                key={index}

...
class AdvancedAIService(BaseAIService):
    ...
    async def strategic_assessment(
        ...
        # Build full context string (avoid f-string in triple-quote for better compatibility)
        full_context = """
        ...
        # Build system prompts (avoid f-string triple-quote for better compatibility)
        ark_prompt_text = urgency_prompts[urgency_level]["ark"]
        ark_system_prompt = """
        ...
        groq_prompt_text = urgency_prompts[urgency_level]["groq"]
        groq_system_prompt = """
